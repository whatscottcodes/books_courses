...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        posRound = (x,y)
        if posRound not in self.cleanedTiles:
            self.cleanedTiles.append(posRound)
    ...
    def getRandomPosition(self):
        ...
        """
        x = random.uniform(0.01, self.width)
        y = random.uniform(0.01, self.height)
        return Position(x, y)
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        posTemp = self.pos.getNewPosition(self.direction, self.speed)
        if self.room.isPositionInRoom(posTemp):
            self.pos = posTemp
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for t in range(num_trials):
        ...
        while curr_coverage < min_coverage:
            ...
            trialSteps+= 1
            curr_coverage = (r.getNumCleanedTiles()/r.getNumTiles())
        steps.append(trialSteps)
        anim.done()
