...
def ReadFemResp1995():
    ...
    returns: DataFrame
    """
    dat_file = 'ts_code/1995FemRespData.dat.gz'
...
def ReadFemResp2010():
    ...
    df = ReadFemResp('ts_code/2006_2010_FemRespSetup.dct',
                       'ts_code/2006_2010_FemResp.dat.gz',
                        usecols=usecols)
    df['evrmarry'] = (df.evrmarry == 1)
...
def ReadFemResp2013():
    ...
    df = ReadFemResp('ts_code/2011_2013_FemRespSetup.dct',
                        'ts_code/2011_2013_FemRespData.dat.gz',
                        usecols=usecols)
    df['evrmarry'] = (df.evrmarry == 1)
...
def ReadFemResp(dct_file='ts_code/2002FemResp.dct',
